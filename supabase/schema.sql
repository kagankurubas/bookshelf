...
create table if not exists books (
  ...
  created_at timestamptz not null default now(),
  -- Free-form tags (independent of category, user-defined, multiple per book).
  -- Plain text[] instead of a separate tags/book_tags table: see migration 013.
...
--    the limit fixed in try_consume_ai_quota below) and return a polite
